    ...
    return function (e) {
        ...
        var i = function () {
            ...
            return n("span", {
                staticClass: "vue-ip",
                class: {
                    "show-port": !1 !== e.netmaskCopy, "material-theme": "material" === e.theme, active: e.active, valid: e.valid
                }
            }, [n("div", {
                staticClass: "label"
            ...
            methods: {
                ...
                paste(e) {
                    ...
                    let t = e.clipboardData.getData("text/plain"),
                        n = t.indexOf(":");
                    if (!1 === this.netmask) {
                        console.warn("A IP address with a netmask has been entered but this module has no netmask attribute. Please enable it update the port."), this.clearAll();
                        let e = t.split(":");
